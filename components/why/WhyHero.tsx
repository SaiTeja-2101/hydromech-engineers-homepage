...
/**
 * Why Us hero: full-bleed cinematic photo with a layered scrim and the title /
 * CTAs overlaid on the left, matching the product and about heroes.
 */
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-white/85">Why Us</span>
          </motion.nav>
