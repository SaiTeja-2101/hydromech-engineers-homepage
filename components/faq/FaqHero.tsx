...
/**
 * FAQ hero: full-bleed cinematic photo with a layered scrim and the title /
 * CTA overlaid on the left, matching the why-us and product heroes.
 */
export default function FaqHero() {
  ...
  return (
    <section className="relative isolate flex min-h-[78svh] items-center overflow-hidden bg-ink">
      {/* full-bleed photo + layered scrim */}
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-white/85">FAQ</span>
          </motion.nav>
